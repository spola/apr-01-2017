...
<head>
    ...
    <style>
        body {
    background-image: url(http://localhost:8585/CodeIgniter-3.1.4/monsters-inc-blanco3.jpg);
...
<div class="row">
  ...
  <div class="container-fluid">
    <div class="navbar-header col-xs-10">
      <a class="navbar-brand" href="<?php echo site_url("Welcome/cargaRecepcion") ?>" style="color:rgb(245,245,245);"><b style="color:rgb(245,245,245); font-family: Monster AG; font-size: 20px;">Monster INC</b></a>
    </div>
      <div class="col-xs-2">
    <ul class="nav navbar-nav navbar-right">
      <li><a href="<?php echo site_url("Welcome/index") ?>" style="color:rgb(245,245,245);"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
    </ul>
    </div>
  </div>
</nav>
    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-body text-center">
                ...
                <h3 class="m0 text-bold">EDITANDO PERFIL</h3>
                <!-- <div class="mv-lg">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="row pv-lg">
                    ...
                    <div class="col-lg-8">
                        <form class="form-horizontal ng-pristine ng-valid" name="formularioEdicion" onsubmit="return validacion()" action="<?php echo site_url("Welcome/editarMonstruo")?>/?id=<?php echo $monstruo_ID ?>" method="post">                            
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input name="nombre" class="form-control" id="inputContact1" type="text" placeholder="" value="<?php echo $Nombre ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input class="form-control" name="apellidos" id="inputContact1" type="text" placeholder="" value="<?php echo $Apellidos ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <input type="date" name="nacimiento" id="nacimiento" class="form-control" value="<?php echo $Nacimiento ?>" required>
                            </div>
                            </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <select class="form-control" name="empleo" id="opciones" data-toggle="tooltip" data-placement="right">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input class="form-control" name="email" id="inputContact2" type="email" value="<?php echo $Email ?>" required>
                                    </div>
                                </div>
                            </div>
              ...
              <div class="text-center">
                  <button type="submit" class="btn-default " id="myStateButton">Guardar</button>
                    <!--<a class="btn btn-default" type="submit" href="InfoPerfilEdicion.html">Guardar</a>-->
                            </div>
                        </form>
                    </div>
                </div>
