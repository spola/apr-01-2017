                ...
                <div class="row transparente">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-xs-offset-4">
                            <input type="submit" class="btn btn-info" value="Acceder como usuario">
                            <div class="row">
                                &nbsp;
                            </div>
                            <a href="<?php echo site_url("welcome/loggedSinUsuario")?>"><input type="button" class="btn btn-info" value="Acceder sin usuario"></a>
                        </div>
                    </div>
                    <div class="row">
                        &nbsp;
