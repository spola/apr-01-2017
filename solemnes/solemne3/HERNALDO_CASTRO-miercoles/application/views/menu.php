    ...
    <body>
                ...
                <nav class="navbar navbar-default navbar-inverse">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown" ><a href="" class="dropdown-toggle" data-toggle="dropdown" role="button">Menu Usuario<span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a href="formulario_ingreso.html">Registar Monster</a></li>
                                    <li><a href="">Buscar Monster</a></li>
                                    <li><a href="">Editar Info Monster</a></li>
                                </ul >
                            </li>
                            <li><a href="Resultado_Ingresado.html">Mis Monsters</a></li>               
