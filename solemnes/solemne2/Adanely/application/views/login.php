...
<head>
    ...
    <style>
        body {
    background-image: url(http://localhost:8585/CodeIgniter-3.1.4/MI-personajes2.jpg);
                ...
                <div class="row login">
                    <div class="col-xs-12">
                        <div class="row">
                            ...
                            <div class="row texto" style="text-align:center">¿No tienes cuenta? <a href="nuevoRegistro"> Regístrate</a></div>
